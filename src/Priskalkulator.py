...
class Application(Frame):
    ...
    def calculateAll(self):
        ...
        try:
            self.resultatAtNormS = int(
                atNormS(self.inkm, self.inmin, self.intillegg))
            self.resultatAtNormM = int(
                atNormM(self.inkm, self.inmin, self.intillegg))
            self.resultatAtNormL = int(
                atNormL(self.inkm, self.inmin, self.intillegg))
            self.resultatAtHelgS = int(
                atHelgS(self.inkm, self.inmin, self.intillegg))
            self.resultatAtHelgM = int(
                atHelgM(self.inkm, self.inmin, self.intillegg))
            self.resultatAtHelgL = int(
                atHelgL(self.inkm, self.inmin, self.intillegg))
            self.resultatAtHolyS = int(
                atHolyS(self.inkm, self.inmin, self.intillegg))
            self.resultatAtHolyM = int(
                atHolyM(self.inkm, self.inmin, self.intillegg))
            self.resultatAtHolyL = int(
                atHolyL(self.inkm, self.inmin, self.intillegg))
            ...
            self.resultatVtNormS = int(
                vtNormS(self.inkm, self.inmin, self.intillegg))
            self.resultatVtNormM = int(
                vtNormM(self.inkm, self.inmin, self.intillegg))
            self.resultatVtNormL = int(
                vtNormL(self.inkm, self.inmin, self.intillegg))
            self.resultatVtKvelS = int(
                vtKvelS(self.inkm, self.inmin, self.intillegg))
            self.resultatVtKvelM = int(
                vtKvelM(self.inkm, self.inmin, self.intillegg))
            self.resultatVtKvelL = int(
                vtKvelL(self.inkm, self.inmin, self.intillegg))
            self.resultatVtHelgS = int(
                vtHelgS(self.inkm, self.inmin, self.intillegg))
            self.resultatVtHelgM = int(
                vtHelgM(self.inkm, self.inmin, self.intillegg))
            self.resultatVtHelgL = int(
                vtHelgL(self.inkm, self.inmin, self.intillegg))
            self.resultatVtHolyS = int(
                vtHolyS(self.inkm, self.inmin, self.intillegg))
            self.resultatVtHolyM = int(
                vtHolyM(self.inkm, self.inmin, self.intillegg))
            self.resultatVtHolyL = int(
                vtHolyL(self.inkm, self.inmin, self.intillegg))
            ...
            self.resultatMtDagS = int(
                mtDagS(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtDagM = int(
                mtDagM(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtDagL = int(
                mtDagL(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtKvelS = int(
                mtKvelS(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtKvelM = int(
                mtKvelM(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtKvelL = int(
                mtKvelL(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtLordS = int(
                mtLordS(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtLordM = int(
                mtLordM(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtLordL = int(
                mtLordL(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtHelgS = int(
                mtHelgS(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtHelgM = int(
                mtHelgM(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtHelgL = int(
                mtHelgL(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtHolyS = int(
                mtHolyS(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtHolyM = int(
                mtHolyM(self.inkm, self.inmin, self.infrem, self.intillegg))
            self.resultatMtHolyL = int(
                mtHolyL(self.inkm, self.inmin, self.infrem, self.intillegg))
            """
    ...
    def createWidgets(self):
        ...
        self.kmEntry = Entry(self, font=("verdana", 10),
        ...
        self.minEntry = Entry(self, font=("verdana", 10),
                              relief=RAISED, justify=RIGHT)
        self.minEntry.insert(0, "0")
        self.minEntry.grid(row=5, column=1)

        self.fremLabel = Label(self, font=(
            "verdana", 10), text="Fremkjøring km:")
        self.fremLabel.grid(row=6, column=0)

        self.fremEntry = Entry(self, font=("verdana", 10),
                               relief=RAISED, justify=RIGHT)
        self.fremEntry.insert(0, "0")
        self.fremEntry.grid(row=6, column=1)

        self.tilleggLabel = Label(self, font=(
            "verdana", 10), text="Tillegg kr:")
        self.tilleggLabel.grid(row=7, column=0)

        self.tilleggEntry = Entry(self, font=(
            "verdana", 10), relief=RAISED, justify=RIGHT)
        self.tilleggEntry.insert(0, "0")
        self.tilleggEntry.grid(row=7, column=1)

        # Buttons

        self.calculateButton = Button(self, font=(
            "verdana", 10), text="Kalkulèr", command=lambda: self.calculateAll())
        self.calculateButton.grid(
            row=10, column=0, columnspan=1, sticky="NWNESWSE")
        self.resetButton = Button(self, font=(
            "verdana", 10), text="Nullstill", command=lambda: self.resetValues())
        self.resetButton.grid(
            row=10, column=1, columnspan=1, sticky="NWNESWSE")

        # Guide

        self.guideTextBox = LabelFrame(self, font=(
            "Verdana", 10, "bold"), text="Bruksanvisning", relief=RIDGE)
        self.guideTextBox.grid(row=4, rowspan=11, column=2, columnspan=15)

        self.guideTidInfo = LabelFrame(self, font=(
            "Verdana", 10, "bold"), text="Tidspunkt:", relief=RIDGE)
        ...
        self.guideTextAgder = Label(self.guideTidInfo, font=(
            "Verdana", 8), text=TidText, justify=LEFT)
        self.guideTextAgder.grid(row=0, column=0)

        self.guideAnnetInfo = LabelFrame(
            self.guideTextBox, font=("Verdana", 10, "bold"), relief=RIDGE)
        ...
        self.guideTextAnnet = Label(self.guideAnnetInfo, font=(
            "Verdana", 8), text=AnnetText, justify=LEFT)
        ...
        self.resultatAtTekst = LabelFrame(self, font=(
            "Verdana", 10, "bold"), text="Agder Taxi", relief=RIDGE)
        self.resultatAtTekst.grid(row=15, column=0, sticky="NWNESWSE")

        self.textAtNormS = Label(self.resultatAtTekst, font=(
            "verdana", 8), text="1-4 PAX | Hverdag")
        self.textAtNormS.grid(row=20, column=2, sticky="W")
        self.resAtNormS = Entry(self.resultatAtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resAtNormS.insert(0, "0")
        self.resAtNormS.grid(row=20, column=3, sticky="NWNESWSE")

        self.textAtHelgS = Label(self.resultatAtTekst, font=(
            "verdana", 8), fg="blue", text="1-4 PAX | Kveld/Helg")
        self.textAtHelgS.grid(row=21, column=2, sticky="W")
        self.resAtHelgS = Entry(self.resultatAtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resAtHelgS.insert(0, "0")
        self.resAtHelgS.grid(row=21, column=3, sticky="NWNESWSE")

        self.textAtHolyS = Label(self.resultatAtTekst, font=(
            "verdana", 8), fg="red", text="1-4 PAX | Helligdag")
        self.textAtHolyS.grid(row=22, column=2, sticky="W")
        self.resAtHolyS = Entry(self.resultatAtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        ...
        self.textAtNormM = Label(self.resultatAtTekst, font=(
            "verdana", 8), text="5-8 PAX | Hverdag")
        self.textAtNormM.grid(row=24, column=2, sticky="W")
        self.resAtNormM = Entry(self.resultatAtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resAtNormM.insert(0, "0")
        self.resAtNormM.grid(row=24, column=3, sticky="NWNESWSE")

        self.textAtHelgM = Label(self.resultatAtTekst, font=(
            "verdana", 8), fg="blue", text="5-8 PAX | Kveld/Helg")
        self.textAtHelgM.grid(row=25, column=2, sticky="W")
        self.resAtHelgM = Entry(self.resultatAtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resAtHelgM.insert(0, "0")
        self.resAtHelgM.grid(row=25, column=3, sticky="NWNESWSE")

        self.textAtHolyM = Label(self.resultatAtTekst, font=(
            "verdana", 8), fg="red", text="5-8 PAX | Helligdag")
        self.textAtHolyM.grid(row=26, column=2, sticky="W")
        self.resAtHolyM = Entry(self.resultatAtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        ...
        self.textAtNormL = Label(self.resultatAtTekst, font=(
            "verdana", 8), text="9-16 PAX | Hverdag")
        self.textAtNormL.grid(row=28, column=2, sticky="W")
        self.resAtNormL = Entry(self.resultatAtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resAtNormL.insert(0, "0")
        self.resAtNormL.grid(row=28, column=3, sticky="NWNESWSE")

        self.textAtHelgL = Label(self.resultatAtTekst, font=(
            "verdana", 8), fg="blue", text="9-16 PAX | Kveld/Helg")
        self.textAtHelgL.grid(row=29, column=2, sticky="W")
        self.resAtHelgL = Entry(self.resultatAtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resAtHelgL.insert(0, "0")
        self.resAtHelgL.grid(row=29, column=3, sticky="NWNESWSE")

        self.textAtHolyL = Label(self.resultatAtTekst, font=(
            "verdana", 8), fg="red", text="9-16 PAX | Helligdag")
        self.textAtHolyL.grid(row=30, column=2, sticky="W")
        self.resAtHolyL = Entry(self.resultatAtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        ...
        self.resultatVtTekst = LabelFrame(self, font=(
            "Verdana", 10, "bold"), text="Vennesla Taxi", relief=RIDGE)
        self.resultatVtTekst.grid(row=15, column=1, sticky="NWNESWSE")

        self.textVtNormS = Label(self.resultatVtTekst, font=(
            "verdana", 8), text="1-4 PAX | Hverdag")
        self.textVtNormS.grid(row=1, column=2, sticky="W")
        self.resVtNormS = Entry(self.resultatVtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resVtNormS.insert(0, "0")
        self.resVtNormS.grid(row=1, column=3, sticky="NWNESWSE")

        self.textVtKvelS = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="purple", text="1-4 PAX | Kveld")
        self.textVtKvelS.grid(row=2, column=2, sticky="W")
        self.resVtKvelS = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="purple", relief=RAISED, justify=RIGHT)
        self.resVtKvelS.insert(0, "0")
        self.resVtKvelS.grid(row=2, column=3, sticky="NWNESWSE")

        self.textVtHelgS = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="blue", text="1-4 PAX | Helg")
        self.textVtHelgS.grid(row=3, column=2, sticky="W")
        self.resVtHelgS = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resVtHelgS.insert(0, "0")
        self.resVtHelgS.grid(row=3, column=3, sticky="NWNESWSE")

        self.textVtHolyS = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="red", text="1-4 PAX | Helligdag")
        self.textVtHolyS.grid(row=4, column=2, sticky="W")
        self.resVtHolyS = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        ...
        self.textVtNormM = Label(self.resultatVtTekst, font=(
            "verdana", 8), text="5-8 PAX | Hverdag")
        self.textVtNormM.grid(row=6, column=2, sticky="W")
        self.resVtNormM = Entry(self.resultatVtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resVtNormM.insert(0, "0")
        self.resVtNormM.grid(row=6, column=3, sticky="NWNESWSE")

        self.textVtKvelM = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="purple", text="5-8 PAX | Kveld")
        self.textVtKvelM.grid(row=7, column=2, sticky="W")
        self.resVtKvelM = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="purple", relief=RAISED, justify=RIGHT)
        self.resVtKvelM.insert(0, "0")
        self.resVtKvelM.grid(row=7, column=3, sticky="NWNESWSE")

        self.textVtHelgM = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="blue", text="5-8 PAX | Helg")
        self.textVtHelgM.grid(row=8, column=2, sticky="W")
        self.resVtHelgM = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resVtHelgM.insert(0, "0")
        self.resVtHelgM.grid(row=8, column=3, sticky="NWNESWSE")

        self.textVtHolyM = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="red", text="5-8 PAX | Helligdag")
        self.textVtHolyM.grid(row=9, column=2, sticky="W")
        self.resVtHolyM = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        ...
        self.textVtNormL = Label(self.resultatVtTekst, font=(
            "verdana", 8), text="9-16 PAX | Hverdag")
        self.textVtNormL.grid(row=11, column=2, sticky="W")
        self.resVtNormL = Entry(self.resultatVtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resVtNormL.insert(0, "0")
        self.resVtNormL.grid(row=11, column=3, sticky="NWNESWSE")

        self.textVtKvelL = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="purple", text="9-16 PAX | Kveld")
        self.textVtKvelL.grid(row=12, column=2, sticky="W")
        self.resVtKvelL = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="purple", relief=RAISED, justify=RIGHT)
        self.resVtKvelL.insert(0, "0")
        self.resVtKvelL.grid(row=12, column=3, sticky="NWNESWSE")

        self.textVtHelgL = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="blue", text="9-16 PAX | Helg")
        self.textVtHelgL.grid(row=13, column=2, sticky="W")
        self.resVtHelgL = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resVtHelgL.insert(0, "0")
        self.resVtHelgL.grid(row=13, column=3, sticky="NWNESWSE")

        self.textVtHolyL = Label(self.resultatVtTekst, font=(
            "verdana", 8), fg="red", text="9-16 PAX | Helligdag")
        self.textVtHolyL.grid(row=14, column=2, sticky="W")
        self.resVtHolyL = Entry(self.resultatVtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        ...
        self.resultatMtTekst = LabelFrame(self, font=(
            "Verdana", 10, "bold"), text="Mandal Taxi", relief=RIDGE)
        self.resultatMtTekst.grid(row=15, column=6, sticky="NWNESWSE")

        self.textMtDagS = Label(self.resultatMtTekst, font=(
            "verdana", 8), text="1-4 PAX | Hverdag")
        self.textMtDagS.grid(row=1, column=2, sticky="W")
        self.resMtDagS = Entry(self.resultatMtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resMtDagS.insert(0, "0")
        self.resMtDagS.grid(row=1, column=3, sticky="NWNESWSE")

        self.textMtKvelS = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="purple", text="1-4 PAX | Kveld")
        self.textMtKvelS.grid(row=2, column=2, sticky="W")
        self.resMtKvelS = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="purple", relief=RAISED, justify=RIGHT)
        self.resMtKvelS.insert(0, "0")
        self.resMtKvelS.grid(row=2, column=3, sticky="NWNESWSE")

        self.textMtLordS = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="blue", text="1-4 PAX | Lørdag")
        self.textMtLordS.grid(row=3, column=2, sticky="W")
        self.resMtLordS = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resMtLordS.insert(0, "0")
        self.resMtLordS.grid(row=3, column=3, sticky="NWNESWSE")

        self.textMtHelgS = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="red", text="1-4 PAX | Helg/Natt")
        self.textMtHelgS.grid(row=4, column=2, sticky="W")
        self.resMtHelgS = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        self.resMtHelgS.insert(0, "0")
        self.resMtHelgS.grid(row=4, column=3, sticky="NWNESWSE")

        self.textMtHolyS = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="gray", text="1-4 PAX | Hellig")
        self.textMtHolyS.grid(row=5, column=2, sticky="W")
        self.resMtHolyS = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="gray", relief=RAISED, justify=RIGHT)
        ...
        self.textMtDagM = Label(self.resultatMtTekst, font=(
            "verdana", 8), text="5-8 PAX | Hverdag")
        self.textMtDagM.grid(row=7, column=2, sticky="W")
        self.resMtDagM = Entry(self.resultatMtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resMtDagM.insert(0, "0")
        self.resMtDagM.grid(row=7, column=3, sticky="NWNESWSE")

        self.textMtKvelM = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="purple", text="5-8 PAX | Kveld")
        self.textMtKvelM.grid(row=8, column=2, sticky="W")
        self.resMtKvelM = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="purple", relief=RAISED, justify=RIGHT)
        self.resMtKvelM.insert(0, "0")
        self.resMtKvelM.grid(row=8, column=3, sticky="NWNESWSE")

        self.textMtLordM = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="blue", text="5-8 PAX | Lørdag")
        self.textMtLordM.grid(row=9, column=2, sticky="W")
        self.resMtLordM = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resMtLordM.insert(0, "0")
        self.resMtLordM.grid(row=9, column=3, sticky="NWNESWSE")

        self.textMtHelgM = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="red", text="5-8 PAX | Helg/Natt")
        self.textMtHelgM.grid(row=10, column=2, sticky="W")
        self.resMtHelgM = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        self.resMtHelgM.insert(0, "0")
        self.resMtHelgM.grid(row=10, column=3, sticky="NWNESWSE")

        self.textMtHolyM = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="gray", text="5-8 PAX | Hellig")
        self.textMtHolyM.grid(row=11, column=2, sticky="W")
        self.resMtHolyM = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="gray", relief=RAISED, justify=RIGHT)
        ...
        self.textMtDagL = Label(self.resultatMtTekst, font=(
            "verdana", 8), text="9-16 PAX | Hverdag")
        self.textMtDagL.grid(row=13, column=2, sticky="W")
        self.resMtDagL = Entry(self.resultatMtTekst, font=(
            "Arial", 8), relief=RAISED, justify=RIGHT)
        self.resMtDagL.insert(0, "0")
        self.resMtDagL.grid(row=13, column=3, sticky="NWNESWSE")

        self.textMtKvelL = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="purple", text="9-16 PAX | Kveld")
        self.textMtKvelL.grid(row=14, column=2, sticky="W")
        self.resMtKvelL = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="purple", relief=RAISED, justify=RIGHT)
        self.resMtKvelL.insert(0, "0")
        self.resMtKvelL.grid(row=14, column=3, sticky="NWNESWSE")

        self.textMtLordL = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="blue", text="9-16 PAX | Lørdag")
        self.textMtLordL.grid(row=15, column=2, sticky="W")
        self.resMtLordL = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="blue", relief=RAISED, justify=RIGHT)
        self.resMtLordL.insert(0, "0")
        self.resMtLordL.grid(row=15, column=3, sticky="NWNESWSE")

        self.textMtHelgL = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="red", text="9-16 PAX | Helg/Natt")
        self.textMtHelgL.grid(row=16, column=2, sticky="W")
        self.resMtHelgL = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="red", relief=RAISED, justify=RIGHT)
        self.resMtHelgL.insert(0, "0")
        self.resMtHelgL.grid(row=16, column=3, sticky="NWNESWSE")

        self.textMtHolyL = Label(self.resultatMtTekst, font=(
            "verdana", 8), fg="gray", text="9-16 PAX | Hellig")
        self.textMtHolyL.grid(row=17, column=2, sticky="W")
        self.resMtHolyL = Entry(self.resultatMtTekst, font=(
            "Arial", 8), fg="gray", relief=RAISED, justify=RIGHT)
